# Fork of https://github.com/RooCodeInc/Roo-Code for local use of gpt-oss only
...
1.  First, build the VSIX package:
    ...
    pnpm vsix
    ```
2.  A `.vsix` file will be generated in the `bin/` directory (e.g., `bin/roo-cline-oss-<version>.vsix`).
