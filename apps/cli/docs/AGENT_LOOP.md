...
The CLI uses type guards from `@roo-code-oss/types` for categorization:

```typescript
import { isIdleAsk, isInteractiveAsk, isResumableAsk, isNonBlockingAsk } from "@roo-code-oss/types"
