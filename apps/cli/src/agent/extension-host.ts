...
import { createVSCodeAPI, IExtensionHost, ExtensionHostEventMap, setRuntimeConfigValues } from "@roo-code-oss/vscode-shim"
import { DebugLogger, setDebugLogEnabled } from "@roo-code-oss/core/cli"
...
export class ExtensionHost extends EventEmitter implements ExtensionHostInterface {
	...
	public markWebviewReady(): void {
		...
		// (apiProvider: "openai") instead of the CLI-provided settings.
		setRuntimeConfigValues("roo-cline-oss", this.initialSettings as Record<string, unknown>)
