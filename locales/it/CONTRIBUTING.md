...
- **Controlla le issue esistenti**: cerca nelle [issue di GitHub](https://github.com/ValentinChirikov/Roo-Code/issues).
...
- Per la documentazione, visita [Roo Code Docs](https://github.com/ValentinChirikov/Roo-Code-Docs).

### Segnalazione di bug

- Controlla prima le segnalazioni esistenti.
- Crea un nuovo bug utilizzando il [modello "Segnalazione di bug"](https://github.com/ValentinChirikov/Roo-Code/issues/new/choose) con:
...
- **Problemi di sicurezza**: segnala in privato tramite [avvisi di sicurezza](https://github.com/ValentinChirikov/Roo-Code/security/advisories/new).
