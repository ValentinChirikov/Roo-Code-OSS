...
- **기존 이슈 확인**: [GitHub 이슈](https://github.com/ValentinChirikov/Roo-Code/issues)에서 검색합니다.
- **이슈 생성**:
...
- 문서는 [Roo Code 문서](https://github.com/ValentinChirikov/Roo-Code-Docs)를 방문하세요.

### 버그 신고하기

- 먼저 기존 보고서가 있는지 확인하세요.
- ["버그 보고" 템플릿](https://github.com/ValentinChirikov/Roo-Code/issues/new/choose)을 사용하여 새 버그를 생성하세요.
    - 명확하고 번호가 매겨진 재현 단계
    - 예상 결과 대 실제 결과
    - Roo Code 버전 (필수), 관련이 있는 경우 API 제공업체/모델
- **보안 문제**: [보안 권고](https://github.com/ValentinChirikov/Roo-Code/security/advisories/new)를 통해 비공개로 보고하세요.
