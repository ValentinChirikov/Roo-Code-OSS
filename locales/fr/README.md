<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-oss"><img src="https://img.shields.io/badge/VS_Code_Marketplace-007ACC?style=flat&logo=visualstudiocode&logoColor=white" alt="VS Code Marketplace"></a>
...
- **[Problèmes GitHub](https://github.com/ValentinChirikov/Roo-Code/issues):** Signalez des bugs et suivez le développement.
- **[Demandes de fonctionnalités](https://github.com/ValentinChirikov/Roo-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop):** Vous avez une idée ? Partagez-la avec les développeurs.
...
1.  D'abord, compilez le package VSIX :
    ...
    pnpm vsix
    ```
2.  Un fichier `.vsix` sera généré dans le répertoire `bin/` (par exemple, `bin/roo-cline-oss-<version>.vsix`).
3.  Installez-le manuellement à l'aide de la CLI de VSCode :
    ```sh
    code --install-extension bin/roo-cline-oss-<version>.vsix
    ```
