...
- **检查现有问题**：在 [GitHub 问题](https://github.com/ValentinChirikov/Roo-Code/issues) 中搜索。
- **使用以下模板创建问题**：
...
- 如需文档，请访问 [Roo Code 文档](https://github.com/ValentinChirikov/Roo-Code-Docs)。

### 报告错误

- 首先检查现有的报告。
- 使用 [“错误报告”模板](https://github.com/ValentinChirikov/Roo-Code/issues/new/choose) 创建一个新错误，并提供：
    - 清晰、编号的复现步骤
    - 预期与实际结果
    - Roo Code 版本（必需）；如果相关，还需提供 API 提供商/模型
- **安全问题**：通过 [安全公告](https://github.com/ValentinChirikov/Roo-Code/security/advisories/new) 私下报告。
