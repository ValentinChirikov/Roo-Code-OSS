...
- **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/ValentinChirikov/Roo-Code/issues).
...
- Для документации посетите [Документацию Roo Code](https://github.com/ValentinChirikov/Roo-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
- Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/ValentinChirikov/Roo-Code/issues/new/choose) с:
...
- **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/ValentinChirikov/Roo-Code/security/advisories/new).
