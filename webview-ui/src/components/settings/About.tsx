...
import type { TelemetrySetting } from "@roo-code-oss/types"
				...
				<div className="flex flex-col gap-3">
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ValentinChirikov/Roo-Code/issues/new?template=bug_report.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ValentinChirikov/Roo-Code/issues/new?template=feature_request.yml">
					...
					<div className="flex items-start gap-2">
						...
						<span>
							...
							<VSCodeLink href="https://github.com/ValentinChirikov/Roo-Code/security/policy">
