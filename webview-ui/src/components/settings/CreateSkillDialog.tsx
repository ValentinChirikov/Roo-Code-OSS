...
import { validateSkillName as validateSkillNameShared, SkillNameValidationError } from "@roo-code-oss/types"
...
/**
 * Validate skill name using shared validation from @roo-code-oss/types.
