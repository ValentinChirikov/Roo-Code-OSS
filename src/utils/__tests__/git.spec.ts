...
[remote "origin"]
 url = https://github.com/ValentinChirikov/Roo-Code.git
...
`
		...
		expect(result).toEqual({
			repositoryUrl: "https://github.com/ValentinChirikov/Roo-Code.git",
...
describe("convertGitUrlToHttps", () => {
	it("should leave HTTPS URLs unchanged", () => {
		const url = "https://github.com/ValentinChirikov/Roo-Code.git"
		const converted = convertGitUrlToHttps(url)

		expect(converted).toBe("https://github.com/ValentinChirikov/Roo-Code.git")
	})
...
describe("sanitizeGitUrl", () => {
	it("should sanitize HTTPS URLs with credentials", () => {
		...
		expect(sanitized).toBe("https://github.com/ValentinChirikov/Roo-Code.git")
	})
...
describe("extractRepositoryName", () => {
	...
	it("should extract repository name from HTTPS URL without .git suffix", () => {
		const url = "https://github.com/ValentinChirikov/Roo-Code"
		const repoName = extractRepositoryName(url)
