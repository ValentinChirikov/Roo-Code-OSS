...
import type { ClineAsk, ToolProgressStatus, ToolGroup, ToolName, GenerateImageParams } from "@roo-code-oss/types"
...
export type NativeToolArgs = {
	...
	read_file: import("@roo-code-oss/types").ReadFileToolParams
